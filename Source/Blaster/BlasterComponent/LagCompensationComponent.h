...
public:	
	...
	void ServerScoreRequest(ABlasterCharacter* HitCharacater, const FVector_NetQuantize& TraceStart,
...
protected:
	...
	//Projectile
	FServerSideRewindResult ProjectileComfirmHit(const FFramePackage& Package, ABlasterCharacter* HitCharacter, const FVector_NetQuantize& TraceStart, 
							const FVector_NetQuantize100& InitialVelocity, float HitTime);

	//Shotgun
	FShotgunServerSideRewindResult ShotgunConfirmHit(const TArray<FFramePackage>& FramePackage, const FVector_NetQuantize& TraceStart, const TArray<FVector_NetQuantize>& HitLocations);
