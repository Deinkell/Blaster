...
#include "Blaster/BlasterTypes/AnnouncementText.h"
...
void ABlasterPlayerController::SetHUDScore(float Score)
{
    ...
    bool bHUDvalid = BlasterHUD && BlasterHUD->CharacterOverlay 
                        && BlasterHUD->CharacterOverlay->SocreAmount;

    if(bHUDvalid)
    {
        FString ScoreText = FString::Printf(TEXT("%d"), FMath::FloorToInt(Score));
        BlasterHUD->CharacterOverlay->SocreAmount->SetText(FText::FromString(ScoreText));
    }
    else
    {
...
void ABlasterPlayerController::SetupInputComponent()
{
    ...
    InputComponent->BindAction("Quit", IE_Pressed, this, &ThisClass::ShouwReturnToMainMenu);
}

void ABlasterPlayerController::ShouwReturnToMainMenu()
{
...
{
    UE_LOG(LogTemp, Warning, TEXT("OnRep_ShowTeamScores"));
    if(bShowTeamScores)
    {
        InitTeamScores();
    }
...
void ABlasterPlayerController::HandleMatchHasStarted(bool bTeamsMatch)
{
    ...
    if(BlasterHUD)
    {
        ...
        if(!HasAuthority())
        {
            if(bShowTeamScores == false) HideTeamScores(); 
            return;
        } 
...
void ABlasterPlayerController::HideTeamScores()
{
    ...
    bool bHUDvalid = BlasterHUD && BlasterHUD->CharacterOverlay 
                        ...
                        && BlasterHUD->CharacterOverlay->SpaceScoreText
                        && BlasterHUD->CharacterOverlay->BlueTeam 
                        && BlasterHUD->CharacterOverlay->RedTeam; 

    if(bHUDvalid)
    {
        BlasterHUD->CharacterOverlay->RedTeamScore->SetText(FText());       
        BlasterHUD->CharacterOverlay->BlueTeamScore->SetText(FText());     
        BlasterHUD->CharacterOverlay->SpaceScoreText->SetText(FText());     
        BlasterHUD->CharacterOverlay->BlueTeam->SetText(FText());     
        BlasterHUD->CharacterOverlay->RedTeam->SetText(FText());   
    }
}
...
{      
    ...
    if(bHUDvalid)
    {
        FString Zero("0");
        FString Spacer("|");
        FString BlueTeam("BlueTeam");
        FString RedTeam("RedTeam");
        BlasterHUD->CharacterOverlay->RedTeamScore->SetText(FText::FromString(Zero));       
        BlasterHUD->CharacterOverlay->BlueTeamScore->SetText(FText::FromString(Zero));     
        BlasterHUD->CharacterOverlay->SpaceScoreText->SetText(FText::FromString(Spacer));     
        BlasterHUD->CharacterOverlay->BlueTeam->SetText(FText::FromString(BlueTeam));     
        BlasterHUD->CharacterOverlay->RedTeam->SetText(FText::FromString(RedTeam));   
    }
}
